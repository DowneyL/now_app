...
class NowTheme {
  ...
  static TextTheme _textSize = TextTheme(
    bodyText1: TextStyle(fontSize: 18.px, fontWeight: FontWeight.w400),
    bodyText2: TextStyle(fontSize: 16.px, fontWeight: FontWeight.w400),
    button: TextStyle(fontSize: 18.px, fontWeight: FontWeight.w500),
